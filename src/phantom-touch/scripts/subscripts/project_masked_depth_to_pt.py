...
sam2config = OmegaConf.load(f"{sam2_dir}/sam2/conf/sam2_segmentation.yaml")
conf = OmegaConf.load(f"{parent_script_dir}/conf/3d_projection.yaml")
...
output_directory_path = conf.sam2hand_directory
shape = conf.shape
...
numpy_masks, mask_paths = load_rgb_images(masks_directory_path, prefix="Color_", return_path=True)
